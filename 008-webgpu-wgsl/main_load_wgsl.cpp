...
// todo: should this be `const std::string& path`?
...
std::string shaderCode2 = LoadFile("./shader.wgsl");
...
void CreateRenderPipeline() {
  std::cout << "=== Old shader code ===" << std::endl;
  std::cout << shaderCode << std::endl;
  std::cout << "=== New shader code ===" << std::endl;
  std::cout << shaderCode2 << std::endl;

  wgpu::ShaderSourceWGSL wgsl{{
      // .code = shaderCode,
      .code = shaderCode2.c_str(),
  }};
